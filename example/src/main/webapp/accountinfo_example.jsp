...
<%
    ...
    String tokenEndpointUri =
        "https://api.sandbox.mkb.hu/auth/realms/ftb-sandbox/protocol/openid-connect/token";
    String authorizationEndpointURI =
        "https://api.sandbox.mkb.hu/auth/realms/ftb-sandbox/protocol/openid-connect/auth";
